                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="text-center">
                                ...
                                <p class="text-capitalize">@if(auth()->guard('admin')->user()->type == 'super admin') Super Administrator @else Administrator @endif</p>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group focused">
                                        ...
                                        <input type="text" id="name" class="form-control" name="first_name" placeholder="Name" value="{{ old('first_name', Auth::user()->first_name) }}">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group focused">
