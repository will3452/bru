...
@section('main-content')
    ...
    <div class="d-flex justify-content-between align-items-center">
        <h1 class="h3 mb-4 text-gray-800">Bulletin</h1>
    </div>
    <div>
        <form action="{{ route('admin.images.bulletin') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                <label for="">Upload Bulletin</label>
