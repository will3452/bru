            ...
            <nav class="navbar navbar-expand navbar-dark bg-primary topbar mb-4 static-top shadow">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown no-arrow">
                        ...
                        <div class="dropdown-menu dropdown-menu-right bg-primary shadow animated--grow-in" aria-labelledby="userDropdown">
                            ...
                            <a class="dropdown-item bg-primary" href="#" data-toggle="modal" data-target="#logoutModal">
