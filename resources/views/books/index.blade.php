...
@section('main-content')
    ...
    <div class="modal-dialog " role="document">
        ...
        <div class="modal-body">
            ...
            <a href="{{ route('thrailers.create') }}" class="btn mb-2 btn-outline-primary d-block text-left d-flex align-items-center"><img src="{{ asset('img/icons/trailer.png') }}" alt="" class="icon-xl"> <span style="font-size:200%">Trailer</span></a>
        </div>
        </div>
    </div>
    </div>
