...
@section('main-content')
    ...
    @if($book->front == null)
        <div class="alert alert-warning d-flex">
            ...
            <div>
                Please click <a href="#"><strong>HERE</strong></a> to upload one .PDF file that contain your BOOK TITLE PAGE, COPYRIGHT PAGE, ACKNOWLEDGMENT PAGE AND DEDICATION PAGE. Thank you!
            </div>
        </div>
    @endif
    <div class="row">
