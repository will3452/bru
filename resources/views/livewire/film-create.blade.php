...
<div>
    ...
    <div class="form-group">
        ...
        <div>
            <input type="checkbox" wire:model="hascollab" value="1" checked="{{$hascollab == 1}}"> Yes
        </div>
        @if ($hascollab == 1)
            <div>
                <label for="">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="number" min="0" placeholder="White Crystal" required name="preview_cost" class="form-control form-control-sm">
                </div>
                <script>
