...
<body>
    ...
    <div class="jumbotron jumbotron-fluid text-white" style="background:url('/img/card-bg-custom.png')">
        <div class="container">
          <h1 class="display-4">BRUMULTIVERSE</h1>
          <p class="lead">ESCAPE INTO THE NOW-KNOWN.</p>
        </div>
    </div>
